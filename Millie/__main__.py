...
from Millie import TOKEN, bot, dp
from Millie.config import get_bool_key, get_list_key
from Millie.modules import ALL_MODULES, LOADED_MODULES, MOD_HELP
...
if get_bool_key("LOAD_MODULES"):
    ...
    for module_name in modules:
        ...
        imported_module = import_module("Millie.modules." + module_name)
...
import_module("Millie.modules.pm_menu")
# Import misc stuff
import_module("Millie.utils.exit_gracefully")
if not get_bool_key("DEBUG_MODE"):
    import_module("Millie.utils.sentry")
