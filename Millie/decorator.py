...
from Millie import BOT_USERNAME, dp
from Millie.config import get_bool_key
from Millie.modules.error import parse_update
from Millie.utils.filters import ALL_FILTERS
...
for module_name in ALL_FILTERS:
    ...
    imported_module = import_module("Millie.utils.filters." + module_name)
