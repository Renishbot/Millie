...
async def select_lang_keyboard(message, strings, edit=False):
    ...
    markup.add(
        InlineKeyboardButton(
            strings["crowdin_btn"], url="https://t.me/millie_robot_update"
        )
    )
    if edit:
...
__help__ = """
This module is dedicated towards utlising Millie's localization feature! You can also <a href='https://crowdin.com/project/MillieXx'>contribute</a> for improving localization in Millie!
...
Millie will send you bunch of inline buttons where you can select your prefered language interatively without any hassles!
"""
