...
from Millie.services.events import register as Millie
...
async def _(event):
    ...
    packshortname = f"Millie_stickers_{userid}"
    kanga = await event.reply("Hello, This Sticker Looks Noice. Mind if Millie steal it")
    ...
    if is_a_s:
        ...
        packshortname = f"Millie_animated_{userid}"
