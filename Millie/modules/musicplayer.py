...
__help__ = """
 ...
 MillieMUSIC plays plays music in your group's voice chat
 
 Assistant name >> @Millie_power_robot
...
*) If userbot joined enjoy music, If not add @Millie_power_robot to your group and retry
...
=>> More tools 🧑‍🔧
  ...
  /userbotjoin: Invite @Millie_power_robot Userbot to your chat
