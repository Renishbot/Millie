...
from Millie.modules.utils.disable import disableable_dec
...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/millie_robot_update"),
        InlineKeyboardButton(
            strings["btn_group"], url="https://t.me/millie_robot_update"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
            "👸🏼 Add Millie to your group",
            url=f"https://telegram.me/Millie_power_robot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/Millie_power_robot?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
