...
from Millie import BOT_ID, OPERATORS, OWNER_ID, bot, decorator
...
In both cases Millie will help you.
...
<code>(file)</code>: required file, if file isn't provided you will be entered in file state, this means Millie will wait file message from you. Type /cancel to leave from it.
